const Storage = (() => {
  ...
  return { getTasks, addTask, updateTask, deleteTask, toggleTaskComplete, getPlannerSchedule, savePlannerSchedule, savePlannerCompletedDates, getStudentName, setStudentName };
})();
